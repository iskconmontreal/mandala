...
export const EXP_CATS = ['utilities', 'kitchen', 'deity', 'maintenance', 'office', 'rent', 'insurance', 'travel', 'salary', 'events', 'professional', 'other']
export const DON_METHODS = ['cash', 'cheque', 'e-transfer', 'card', 'in-kind']
export const EXP_TYPES = ['direct', 'reimbursement', 'advance']
export const EXP_STATUSES = {
  draft:     { color: 'var(--c-text-dim)' },
  submitted: { color: 'var(--c-accent)' },
  returned:  { color: 'var(--c-warn)' },
  rejected:  { color: 'var(--c-err)' },
  approved:  { color: 'var(--c-ok)' },
  paid:      { color: 'var(--c-accent)' },
  closed:    { color: 'var(--c-text-dim)' },
}
